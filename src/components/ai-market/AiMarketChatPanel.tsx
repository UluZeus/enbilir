...
const copy = {
  tr: {
    ...
    vipBody: "Site içi kanıta güncel, kaynaklı internet araştırması ve özel VIP araştırma bağlamını ekler. Tanıtım döneminde bu kapsam tüm üyelere açıktır.",
    standardPay: "70 TL katkı linki",
    vipPay: "100 TL VIP linki",
    promoBody: "Tanıtım döneminde giriş yapan tüm üyeler tam VIP kapsamını kullanır.",
    freeQuota: "Ödeme yapmadan günlük 5 AI sorgu hakkınız var. Haklarınız her gece İstanbul saatiyle 00.00'da sıfırlanır.",
  ...
  en: {
    ...
    vipBody: "Adds current cited web research and private VIP research context to site evidence. This scope is open to all members during the launch promotion.",
    standardPay: "70 TL contribution link",
    vipPay: "100 TL VIP link",
    promoBody: "During the launch promotion, every signed-in member receives the full VIP scope.",
    freeQuota: "Without payment, you have 5 AI queries per day. Your allowance resets every night at 00:00 Istanbul time.",
          ...
          <section className={`rounded-xl border p-3 ${effectiveTier === "VIP" ? "border-amber-300/25 bg-amber-300/10" : "border-cyan-300/20 bg-cyan-300/8"}`}>
            ...
            <div className="mt-2 rounded-lg border border-white/10 bg-slate-950/45 px-3 py-2.5">
              ...
              <p className="mt-1 text-sm font-bold text-white">
                {text.remaining}: {quota?.remaining ?? (paidVipActive ? 15 : 5)}/{quota?.limit ?? (paidVipActive ? 15 : 5)}
              </p>
