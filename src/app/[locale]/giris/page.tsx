  ...
  return (
    <div className="grid gap-6">
      ...
      <section className="mx-auto grid w-full max-w-5xl gap-6 lg:grid-cols-[0.9fr_1.1fr]">
        <div className="auth-login-story premium-card premium-card--dark p-6">
        ...
        <form action={loginAction} className="auth-conversion-form grid w-full gap-4 rounded-[1.35rem] border border-slate-200 bg-white p-6 shadow-sm">
